...
<body>
    ...
    <header class="home section" id="home">
        <nav>
            <div class="container">
                <h1 class="logo"><a href="index.php">synceday<span>one</span>
                    </a>
                </h1>
                <div class="menu-overlay"></div>
                <div class="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-item"><a class="active" href="index.php#" data-value="#home">Home</a>
                        </li>
                        <li class="menu-item"><a href="index.php#" data-value="#audit">Digital audit</a>
                        </li>
                        <li class="menu-item"><a href="index.php#matrix" data-value="#matrix">Matrix</a>
                        </li>
                        <li class="menu-item"><a href="index.php#media" data-value="#media">Media Buying</a>
                        </li>

                        <li class="menu-item"><a href="index.php#resources" data-value="#resources">Resources</a>
                        </li>

                        <li class="menu-item"><a href="index.php#contact" data-value="#contact">No Mediocre</a>
                        </li>
        ...
        <div class="header-content" id="home">
            <div class="container half-height">
                <div class="content-text">
                    ...
                    <div class="buttons-container"><a class="rounded-btn color-one solid shadow" href="index.php#">Learn
                            More</a>
                    </div>
                </div>
    ...
    <!-- End Header-->
    <!-- Start Audit-->
    <div class="about section" id="audit" style="background-color: #F5F4F5;">
        <div class="container">
            ...
            <div class="who-are-we">
                ...
                <div class="who-are-we-text">
                    ...
                    <div class="buttons-container"><a class="rounded-btn color-one shadow" href="about.html">Learn
                            More</a>
                    </div>
                </div>
            </div>
    ...
    <!-- Start Matrix-->
    <div class="about section" id="matrix">
        <div class="container">
            ...
            <div class="who-are-we">
                ...
                <div class="who-are-we-text">
                    <h2>SD1 Matrix</h2>
                    <p>For effective marketing communication, it's important to build a quality brand. Be deliberate
                        with your
                        brand building
    ...
    <!-- Start Contact Box-->
    <div class="contact-box section" id="resources">
        <div class="container">
            <div class="box">
                <h2 class="box-title">SD1 Resources </h2>
                <p>For DIY marketing efforts, here are some resources to help build a formidable brand and marketing
                    campaign
                </p>
    ...
    <div class="contact section" id="contact" style="background-color: #F5F4F5;">
        <div class=" container">
            <div class="section-title">
                ...
                <p>Sign up to our monthly Newsletter, No Mediocre! and get vital updates, insights, and perspective on
                    all
